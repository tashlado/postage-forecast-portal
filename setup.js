...
function seedConfigRows_() {
  return [
    ...
    ['GUIDE_URL',                 'https://docs.google.com/document/d/1ajXraZ2XjONizuhw3FnK-FGvhnCfZftBnPpxKl6smjg/edit',
                                                'Postage Forecast Guide — the editable address, for the "Open in Google Docs" links'],
    ['GUIDE_PUB_URL',             'https://docs.google.com/document/d/e/2PACX-1vR1Mz74WFukoKzV5fISEI9sPE-cPjiWLejSakl10RyAdgp0qoYc-O_nB0Yiw8ARN_KRqUsDu1Kx7Qqi/pub',
                                                'The PUBLISHED address the Guide tab reads. From File > Share > Publish to web. Not derivable from GUIDE_URL'],
